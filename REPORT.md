...
Форма фронтов на [`results/fig_pareto.png`](results/fig_pareto.png) объясняет числа: денойзер задания и
контрастное плечо идут по **той же** кривой, что наивный стиринг, лишь уезжая дальше вправо — то есть
скользят по фронту, а не сдвигают его. Это ровно предсказание H2, и оно подтвердилось.
