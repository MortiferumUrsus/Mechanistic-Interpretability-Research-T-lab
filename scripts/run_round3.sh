#!/usr/bin/env bash
# Bash mirror of run_round3.ps1; the PowerShell file is the one the reported runs used.
...
# run_round2.sh trains dir_hot BEFORE these twelve features exist, so without retraining the round-three
